...
public class BoardDAOSpring {
	...
	public void insertBoard(BoardVO vo) {
		...
		Object[] args = {vo.getSeq(), vo.getTitle(), vo.getWriter(), vo.getContent()}; // 방법1. Object array
	...
	public void updateBoard(BoardVO vo) {
		...
		spring.update(BOARD_UPDATE, vo.getTitle(), vo.getWriter(), vo.getSeq()); // 방법2. 직접 파람에 넣기
	}

	// 글 삭제
	public void deleteBoard(BoardVO vo) {
		System.out.println("===> Spring 기반으로 deleteBoard() 기능 처리");
		spring.update(BOARD_DELETE);
	}
